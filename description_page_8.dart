...
void main() => runApp(MaterialApp(
      ...
      home: DescriptionPageEight(),
    ));

class DescriptionPageEight extends StatefulWidget {
  @override
  _DescriptionPageEightState createState() => _DescriptionPageEightState();
}

class _DescriptionPageEightState extends State<DescriptionPageEight> {
  @override
                    ...
                    Container(
                      ...
                      decoration: ShapeDecoration(
                        image: DecorationImage(
                          image: AssetImage(
                              "assets/images/house_8.jpg"), // Replace with your actual asset image path
                          fit: BoxFit.fill,
                        ),
                    ...
                    child: Text.rich(
                      TextSpan(
                        children: [
                          TextSpan(
                            text:
                                'Large, unfurnished room that provides a blank canvas for your ideas. Flexible space accommodates a range of needs...',
                            style: TextStyle(
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                            ...
                            decoration: ShapeDecoration(
                              image: DecorationImage(
                                image: AssetImage("assets/images/house_9.jpg"),
                                fit: BoxFit.fill,
                              ),
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(8),
