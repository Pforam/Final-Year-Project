...
void main() => runApp(MaterialApp(
      ...
      home: DescriptionPageSeven(),
    ));

class DescriptionPageSeven extends StatefulWidget {
  @override
  _DescriptionPageSevenState createState() => _DescriptionPageSevenState();
}

class _DescriptionPageSevenState extends State<DescriptionPageSeven> {
  @override
                    ...
                    Container(
                      ...
                      decoration: ShapeDecoration(
                        image: DecorationImage(
                          image: AssetImage(
                              "assets/images/house_7.jpg"), // Replace with your actual asset image path
                          fit: BoxFit.fill,
                        ),
                    ...
                    child: Text.rich(
                      TextSpan(
                        children: [
                          TextSpan(
                            text:
                                'Large, unfurnished space that is ready for your ideas. Flexible space accommodates a range of requirements...',
                            style: TextStyle(
